...
import nl.uscki.appcki.wilson.helpers.bbparser.spans.ClickableSpan;
...
public class Section extends GenericElement {
    ...
    public SpannableStringBuilder getSpannedText(BBTextView view) {
        ...
        str.insert(0, prefix);
        str.setSpan(new TextAppearanceSpan(view.getContext(), R.style.AppTheme_TextSubHeader), 0, prefix.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        str.setSpan(new ClickableSpan() {
            ...
            public void onClick(View widget) {
                ...
                if(view.visibilityOfBBUnit) {
                    str2.setSpan(new TextAppearanceSpan(view.getContext(), R.style.SpoilerTextVisible), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    view.visibilityOfBBUnit = false;
                } else {
                    str2.setSpan(new TextAppearanceSpan(view.getContext(), R.style.SpoilerTextInvisible), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        str.setSpan(new TextAppearanceSpan(view.getContext(), R.style.SpoilerTextVisible), prefix.length(), str.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        return str;
    }
}
