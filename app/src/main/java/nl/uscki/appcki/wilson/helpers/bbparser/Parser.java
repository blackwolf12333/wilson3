package nl.uscki.appcki.wilson.helpers.bbparser;
        ...
        for (Object object: toParse) {
            ...
            if(object.getClass().getSimpleName().equals("String")) {
                ...
                if (string.contains("CKI")) {
                    ...
                    //Typeface myTypeface = Typeface.create(ResourcesCompat.getFont(view.getContext(), R.font.ckilogos), Typeface.NORMAL);

                    //str.setSpan(new TypefaceSpan(myTypeface), start, start+1, Spanned.SPAN_EXCLUSIVE_INCLUSIVE);
                    output.append(str);
                } else {
