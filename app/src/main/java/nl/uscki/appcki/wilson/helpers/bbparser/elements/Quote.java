...
import nl.uscki.appcki.wilson.helpers.bbparser.spans.QuoteSpan;
...
public class Quote extends GenericElement {
    ...
    public SpannableStringBuilder getSpannedText(BBTextView view) {
        ...
        str.setSpan(new QuoteSpan(view.getContext()), name.length(), str.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        return str;
    }
}
